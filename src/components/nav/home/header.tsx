              ...
              <nav className="flex flex-col items-center space-y-6 mb-8 w-full">
                ...
                <div className="py-4 flex flex-col items-center space-y-4">
                  ...
                  {mounted && (
                    <button
                      onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}
                      className="flex items-center space-x-2 px-4 py-2 bg-gray-100 dark:bg-white/10 rounded-full text-gray-700 dark:text-white/90 hover:bg-gray-200 dark:hover:bg-white/20 transition-colors"
                    >
                      {theme === 'dark' ? (
                        <>
